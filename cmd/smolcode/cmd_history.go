...
func handleHistoryNewCommand(args []string) {
...
func handleHistoryAppendCommand(args []string) {
...
func handleHistoryListCommand(args []string) {
...
func handleHistoryShowCommand(args []string) {
...
func handleHistoryCommand(args []string) {
	...
	switch subcommand {
	case "new":
		handleHistoryNewCommand(remainingArgs)

	case "append":
		handleHistoryAppendCommand(remainingArgs)

	case "list":
		handleHistoryListCommand(remainingArgs)

	case "show":
		handleHistoryShowCommand(remainingArgs)
